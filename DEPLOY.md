...
| Tools exposed | mail, calendar, OneDrive/Files, SharePoint — 127 tools                       |
...
4. **Solvei MCPServer row**, per org:
   ...
   - `tool_filter` if this customer should see less than the full 127
...
caps this host at mail, calendar, OneDrive/Files and SharePoint — 127 of the
